...
def find_imgs(url):
    html = url_open(url).decode('utf-8')
    imgs_url = re.findall(r'https://www.chegg.com/\d{6}',html)
    return imgs_url
...
def download(folder = 'crawler_download',*pages):
    if not os.path.exists(folder):
        os.mkdir(folder)
    os.chdir(folder)

#Ex:url = 'https://www.chegg.com/homework-help/Advanced-Engineering-Mathematics-2nd-edition-chapter-17.3-problem-18ED-solution-9780133214314'
    url = 'https://www.chegg.com/homework-help/Advanced-Engineering-Mathematics-2nd-edition-chapter-'
...
if __name__ == '__main__':
	chapter = [];
    download('crawler_download',1)#第一个参数为文件夹名，第二个参数为要爬取的页码
